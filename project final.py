...
txtDisplay=Entry(calc,font=('Arial',20,'bold'),bg='powder blue',bd=20,width=29,justify=RIGHT)
...
btnSqrt=Button(calc,text='√',width=6,height=2,font=('arial',20,'bold'),bd=4,bg='powder blue',command=added_value.sqrt).grid(row=1,column=2,pady=1)
...
btnbyx=Button(calc,text='1/x',width=6,height=2,font=('arial',20,'bold'),bd=4,bg='powder blue',command=added_value.byx).grid(row=2,column=4,pady=1)
...
btnfact=Button(calc,text='n!',width=6,height=2,font=('arial',20,'bold'),bd=4,bg='powder blue',command=added_value.fact).grid(row=5,column=5,pady=1)
btnpow=Button(calc,text='nᵐ',width=6,height=2,font=('arial',20,'bold'),bd=4,bg='powder blue',command=lambda:added_value.operation('pow')).grid(row=5,column=6,pady=1)
btnsquare=Button(calc,text='x²',width=6,height=2,font=('arial',20,'bold'),bd=4,bg='powder blue',command=added_value.square).grid(row=5,column=7,pady=1)

lblDisplay=Label(calc,text="Scientific Calculator",justify=CENTER,font=('arial',20,'bold')).grid(row=0,column=4,columnspan=4)
